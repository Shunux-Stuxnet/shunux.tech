	...
	<div class="p-8 grid grid-cols-4 items-end">
		<div class="links col-span-3" id="social-links">
			...
			<div class="flex flex-row w-full mb-4">
				<a
					class="icon-link"
					href="https://github.com/Shunux-Stuxnet/"
					target="_blank"
					rel="noreferrer"
				>
					github
				...
				<a
					class="icon-link"
					href="https://www.linkedin.com/in/shunux-stuxnet/"
					target="_blank"
					rel="noreferrer"
				>
					linkedin
				...
				<a
					class="icon-link"
					href="https://leetcode.com/shunux/"
					target="_blank"
					rel="noreferrer"
				>
					leetcode
				...
				<a
					class="icon-link"
					href="https://twitter.com/CySecDF"
					target="_blank"
					rel="noreferrer"
				>
					twiiter
				...
				<a class="icon-link" href="mailto:nitya.nandjha2020@vitbhopal.ac.in">
					e-mail
					<svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
