...
<div class="flex flex-wrap mt-4 gap-4">
	<a href="skills" class="button tag-button tag-button--vue"> Java </a>
	<a href="/skills" class="button tag-button tag-button--css"> OSINT </a>
	<a href="/skills" class="button tag-button tag-button--vue"> Web Pentesting </a>
	<a href="/skills" class="button tag-button tag-button--react"> Golang </a>
	<a href="/skills" class="button tag-button tag-button--vue"> Bash </a>
	<a href="/skills" class="button tag-button tag-button--vue"> Python </a>
</div>
